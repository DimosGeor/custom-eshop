 ...
 */
function absolute_url ($page = 'eshopmain.php') {
...
function check_login($dbc, $email = '', $pass = '') {
	...
	if (empty($errors)) { // If everything's OK.
		...
		// Retrieve the  and first_name for that email/password combination:
		$q = "SELECT  name FROM users WHERE email='$e' AND pass=SHA1('$p')";		
